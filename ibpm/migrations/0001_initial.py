# Generated by Django 5.2.3 on 2025-06-28 19:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geneName', models.CharField(blank=True, default='', help_text='Abbreviated Name of the Gene', max_length=200, verbose_name='Gene Name')),
            ...
            options={
                'indexes': [models.Index(fields=['geneName'], name='ibpm_genepr_geneNam_818f32_idx'), models.Index(fields=['protName'], name='ibpm_genepr_protNam_60ad39_idx'), models.Index(fields=['entryName'], name='ibpm_genepr_entryNa_b42ee3_idx'), django.contrib.postgres.indexes.GinIndex(fields=['geneName'], name='geneprot_genename_gin', opclasses=['gin_trgm_ops']), django.contrib.postgres.indexes.GinIndex(fields=['protName'], name='geneprot_protname_gin', opclasses=['gin_trgm_ops']), django.contrib.postgres.indexes.GinIndex(fields=['entryName'], name='geneprot_entryname_gin', opclasses=['gin_trgm_ops']), django.contrib.postgres.indexes.GinIndex(fields=['altGeneNames'], name='geneprot_altnames_gin', opclasses=['gin_trgm_ops']), django.contrib.postgres.indexes.GinIndex(fields=['geneProtFullNames'], name='geneprot_fullnames_gin', opclasses=['gin_trgm_ops'])],
            },
        ),
        migrations.CreateModel(
            name='Peptide',
