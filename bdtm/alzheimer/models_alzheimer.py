...
class Alzheimer_1_GSE12685(models.Model):
...
class Alzheimer_1_GSE12685_Metadata(models.Model):
    ...
    groupII = models.IntegerField(choices=ALZHEIMER_GRADES)

# # # # # # # # # # # # # # # # # # # 
# Alzheimer 2
# # # # # # # # # # # # # # # # # # # 

class Alzheimer_2_GSE1297(models.Model):
    probeId = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_2_GSE1297_Metadata(models.Model):
    accession = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_3_GSE28146(models.Model):
    probeId = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_3_GSE28146_Metadata(models.Model):
    accession = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_4_GSE4757(models.Model):
    probeId = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_4_GSE4757_Metadata(models.Model):
    accession = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_5_GSE16759(models.Model):
    probeId = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_5_GSE16759_Metadata(models.Model):
    accession = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_6_GSE5281(models.Model):
    probeId = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_6_GSE5281_Metadata(models.Model):
    accession = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_7_GSE48350(models.Model):
    probeId = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
...
class Alzheimer_7_GSE48350_Metadata(models.Model):
    accession = models.CharField(
        max_length=200,
        help_text="The Probe ID",
        verbose_name="Probe ID",
