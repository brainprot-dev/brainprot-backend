...
class Huntington_1_GSE3790_U133A_Resource(resources.ModelResource):
...
class Huntington_1_GSE3790_U133A_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Huntington_1_GSE3790_U133A_Resource

    list_display = ('geneName',)
    search_fields = ['geneName']
    #prepopulated_fields = {'slug': ('peptideSequence',)}

class Huntington_1_GSE3790_U133A_Metadata_Resource(resources.ModelResource):
...
class Huntington_1_GSE3790_U133A_Metadata_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Huntington_1_GSE3790_U133A_Metadata_Resource
...
class Huntington_2_GSE3790_U133B_Resource(resources.ModelResource):
...
class Huntington_2_GSE3790_U133B_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Huntington_2_GSE3790_U133B_Resource

    list_display = ('geneName',)
    search_fields = ['geneName']
    #prepopulated_fields = {'slug': ('peptideSequence',)}

class Huntington_2_GSE3790_U133B_Metadata_Resource(resources.ModelResource):
...
class Huntington_2_GSE3790_U133B_Metadata_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Huntington_2_GSE3790_U133B_Metadata_Resource
