...
# For example, if Giloma has two datasets (PXD Accession IDs)
# There should be two classes:
# Mengioma_1_PXDXXXXXX, Glioma_2_PXDXXXXXX
# # # # # # # # # # # # # # # # # # # 
# REGARDING METADATA
# # # # # # # # # # # # # # # # # # #
...
class Glioma_1_PXD010247(models.Model):
...
# class Glioma_1_PXD010247_Unprocessed(models.Model):
#     proteinId = models.CharField(
#         max_length=200,
#         help_text="UniProt Protein ID",
#         verbose_name="Protein ID",
...
class Glioma_1_PXD010247_Metadata(models.Model):
    # GROUP_III_CHOICES = (
    #     (0, 'Anaplastic'),
    #     (1, 'Atypical'),
    #     (2, 'Fibroplastic'),
    ...
    groupII = models.IntegerField(choices=Glioma_GRADES)
...
class Glioma_2_PXD014606(models.Model):
    proteinId = models.CharField(
        max_length=200,
        help_text="UniProt Protein ID",
        verbose_name="Protein ID",
...
class Glioma_2_PXD014606_Metadata(models.Model):
    sourceName = models.TextField(
        help_text="Name of Source File",
        verbose_name="Source Name"
    )
...
class Glioma_3_PXD028931(models.Model):
    proteinId = models.CharField(
        max_length=200,
        help_text="UniProt Protein ID",
        verbose_name="Protein ID",
...
# class Glioma_3_PXD028931_Unprocessed(models.Model):
#     proteinId = models.CharField(
#         max_length=200,
#         help_text="UniProt Protein ID",
#         verbose_name="Protein ID",
...
class Glioma_3_PXD028931_Metadata(models.Model):
    # GROUP_I_CHOICES = (
    #     (0, 'Primary'),
    #     (1, 'Recurrence 1st'),
    #     (2, 'Recurrence 2nd'),
