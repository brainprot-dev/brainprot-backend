...
# For example, if Amyotrophic_Lateral_Sclerosis has two datasets (PXD Accession IDs)
# There should be two classes:
# Mengioma_1_PXDXXXXXX, Amyotrophic_Lateral_Sclerosis_2_PXDXXXXXX
# # # # # # # # # # # # # # # # # # # 
# REGARDING METADATA
# # # # # # # # # # # # # # # # # # #
...
# Amyotrophic_Lateral_Sclerosis_GRADES = (
#         (0, 'Control'),
#         (1, 'Grade 1'),
#         (2, 'Grade 2'),
#         (3, 'Grade 3'),
...
class Amyotrophic_Lateral_Sclerosis_1_PXD021630(models.Model):
...
# class Amyotrophic_Lateral_Sclerosis_1_PXD021630_Unprocessed(models.Model):
#     proteinId = models.CharField(
#         max_length=200,
#         help_text="UniProt Protein ID",
#         verbose_name="Protein ID",
...
class Amyotrophic_Lateral_Sclerosis_1_PXD021630_Metadata(models.Model):
    # GROUP_III_CHOICES = (
    #     (0, 'Anaplastic'),
    #     (1, 'Atypical'),
    #     (2, 'Fibroplastic'),
    ...
    # groupII = models.IntegerField(choices=Amyotrophic_Lateral_Sclerosis_GRADES)
...
# class Amyotrophic_Lateral_Sclerosis_2_PXD014852(models.Model):
#     proteinId = models.CharField(
#         max_length=200,
#         help_text="UniProt Protein ID",
#         verbose_name="Protein ID",
...
# # class Amyotrophic_Lateral_Sclerosis_2_PXD014852_Unprocessed(models.Model):
# #     proteinId = models.CharField(
# #         max_length=200,
# #         help_text="UniProt Protein ID",
# #         verbose_name="Protein ID",
...
# class Amyotrophic_Lateral_Sclerosis_2_PXD014852_Metadata(models.Model):
#     sourceName = models.TextField(
#         help_text="Name of Source File",
#         verbose_name="Source Name"
#     )
...
# class Amyotrophic_Lateral_Sclerosis_3_PXD012923(models.Model):
#     proteinId = models.CharField(
#         max_length=200,
#         help_text="UniProt Protein ID",
#         verbose_name="Protein ID",
...
# # class Amyotrophic_Lateral_Sclerosis_3_PXD012923_Unprocessed(models.Model):
# #     proteinId = models.CharField(
# #         max_length=200,
# #         help_text="UniProt Protein ID",
# #         verbose_name="Protein ID",
...
# class Amyotrophic_Lateral_Sclerosis_3_PXD012923_Metadata(models.Model):
#     GROUP_I_CHOICES = (
#         (0, 'Primary'),
#         (1, 'Recurrence 1st'),
#         (2, 'Recurrence 2nd'),
