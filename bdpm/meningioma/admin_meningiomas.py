...
class Meningioma_3_PXD012923_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Meningioma_3_PXD012923_Resource
...
class Meningioma_4_PXD015979_Resource(resources.ModelResource):

    class Meta:
        # Controls which Model this resource is for
        model = Meningioma_4_PXD015979
        # Fields useful for import and export
...
class Meningioma_4_PXD015979_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Meningioma_4_PXD015979_Resource

    list_display = ('proteinId',)
    search_fields = ['proteinId']

class Meningioma_4_PXD015979_Metadata_Resource(resources.ModelResource):

    class Meta:
        # Controls which Model this resource is for
        model = Meningioma_4_PXD015979_Metadata
        # Fields useful for import and export
        fields = ('sourceName', 'sampleId', 'sampleName', 'gender', 'age', 'groupI', 'groupII', )
        # Fields which will be useful for object identification during import
        import_id_fields = ('sourceName', )
...
class Meningioma_4_PXD015979_Metadata_Admin(ImportExportMixin, admin.ModelAdmin):
    # For ImportExportMixin Interface, we set what resource class it deals with
    resource_class = Meningioma_4_PXD015979_Metadata_Resource
